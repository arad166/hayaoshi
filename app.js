new Vue({
  ...
  methods: {
    displayNumber(event) {
      ...
      if (keyCode >= 48 && keyCode <= 57 && !this.showNumber && key != this.oyasumi) {
        this.number = key;
        this.showNumber = true;
        playBuzzer();
      } else if (keyCode >= 48 && keyCode <= 57 && this.showNumber && !this.showNumber2 && key != this.number && key != this.oyasumi){
        this.number2 = key;
